...
ActiveRecord::Schema[8.1].define(version: 2026_03_03_143537) do
  ...
  create_table "watch_sessions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["chat_id"], name: "index_watch_sessions_on_chat_id"
    t.index ["email"], name: "index_watch_sessions_on_email", unique: true
    t.index ["reset_password_token"], name: "index_watch_sessions_on_reset_password_token", unique: true
    t.index ["user_id"], name: "index_watch_sessions_on_user_id"
  end

  create_table "watchsessions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "watch_sessions", "chats"
